...
namespace esport_leauge
{
    partial class DataModule
    {
        ...
        private void InitializeComponent()
        {
            ...
            // dbConnection
            // 
            this.dbConnection.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\temp\\NZESL.mdb";
            // 
            // oleDbSelectCommand1
            // 
    ...
    "city`) VALUES (?, ?, ?, ?, ?)";
            this.oleDbInsertCommand2.Connection = this.dbConnection;
            ...
            this.oleDbUpdateCommand2.Connection = this.dbConnection;
            ...
            this.oleDbDeleteCommand2.Connection = this.dbConnection;
    ...
    "Address`, `FirstName`) VALUES (?, ?, ?, ?, ?, ?)";
            this.oleDbInsertCommand3.Connection = this.dbConnection;
            ...
            this.oleDbUpdateCommand3.Connection = this.dbConnection;
            ...
            this.oleDbDeleteCommand3.Connection = this.dbConnection;
    ...
    "`Status` = ?)))";
            this.oleDbUpdateCommand4.Connection = this.dbConnection;
    ...
    " 1 AND `Status` IS NULL) OR (`Status` = ?)))";
            this.oleDbDeleteCommand4.Connection = this.dbConnection;
    ...
    "ORDER BY EventID";
            this.oleDbSelectCommand5.Connection = this.dbConnection;
            // 
            // oleDbInsertCommand5
            // 
            this.oleDbInsertCommand5.CommandText = "INSERT INTO `EVENT` (`EventName`, `ArenaID`, `Status`, `Capacity`, `EventDate`) V" +
    "ALUES (?, ?, ?, ?, ?)";
            this.oleDbInsertCommand5.Connection = this.dbConnection;
            ...
            this.oleDbUpdateCommand5.Connection = this.dbConnection;
            ...
            this.oleDbDeleteCommand5.Connection = this.dbConnection;
